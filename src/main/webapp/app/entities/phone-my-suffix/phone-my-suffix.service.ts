...
export class PhoneMySuffixService {
    ...
    create(phone: PhoneMySuffix): Observable<PhoneMySuffix> {
    ...
    update(phone: PhoneMySuffix): Observable<PhoneMySuffix> {
        const copy = this.convert(phone);
    ...
    find(id: number): Observable<PhoneMySuffix> {
     ...
     */
    private convertItemFromServer(json: any): PhoneMySuffix {
        const entity: PhoneMySuffix = Object.assign(new PhoneMySuffix(), json);
        return entity;
    }
