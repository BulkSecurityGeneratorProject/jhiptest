...
@Component({
    selector: 'jhi-organisation-my-suffix',
    templateUrl: './organisation-my-suffix.component.html'
})
export class OrganisationMySuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: OrganisationMySuffix) {
        return item.id;
    }
