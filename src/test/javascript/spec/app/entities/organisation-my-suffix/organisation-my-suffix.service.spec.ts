...
describe('Service Tests', () => {
    ...
    describe('OrganisationMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OrganisationMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/organisations/' + 123);
            });
            it('should return OrganisationMySuffix', () => {

                let entity: OrganisationMySuffix;
                service.find(123).subscribe((_entity: OrganisationMySuffix) => {
                    entity = _entity;
                });
