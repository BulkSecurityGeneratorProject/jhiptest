...
describe('Service Tests', () => {
    ...
    describe('EntryMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntryMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return EntryMySuffix', () => {

                let entity: EntryMySuffix;
                service.find(123).subscribe((_entity: EntryMySuffix) => {
                    entity = _entity;
                });
