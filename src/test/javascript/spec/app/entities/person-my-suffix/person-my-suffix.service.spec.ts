...
describe('Service Tests', () => {
    ...
    describe('PersonMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PersonMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return PersonMySuffix', () => {

                let entity: PersonMySuffix;
                service.find(123).subscribe((_entity: PersonMySuffix) => {
                    entity = _entity;
                });
