...
describe('Service Tests', () => {
    ...
    describe('MembershipMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MembershipMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/memberships/' + 123);
            });
            it('should return MembershipMySuffix', () => {

                let entity: MembershipMySuffix;
                service.find(123).subscribe((_entity: MembershipMySuffix) => {
                    entity = _entity;
                });
